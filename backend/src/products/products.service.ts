...
export class ProductsService {
  ...
  async create(dto: CreateProductDto) {
    ...
    const product = await this.prisma.product.create({
      data: {
        ...
        isbn: dto.isbn ?? null,
        book_format: dto.book_format ?? null,
        page_count: dto.page_count ?? null,
        publisher: dto.publisher ?? null,
        amazon_url: dto.amazon_url ?? null,
        goodreads_url: dto.goodreads_url ?? null,
        stripe_tax_code: dto.stripe_tax_code ?? null,
        shipping_override: dto.shipping_override ?? null,
  ...
  async update(id: string, dto: UpdateProductDto, userId: string, canEditOwn = false, canEditAny = false) {
    ...
    const updateData: Prisma.ProductUpdateInput = {
      ...
      amazon_url: dto.amazon_url,
      goodreads_url: dto.goodreads_url,
      stripe_tax_code: dto.stripe_tax_code,
      shipping_override: dto.shipping_override,
